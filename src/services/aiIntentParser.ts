    ...
    const romanticOptions: SuggestionOption[] = [
      {
        ...
        merchantAddress: '0x49c6d4Eb5e0988647E335F3f83ded44955E9FCFD',
      ...
      },
      {
        ...
        merchantAddress: '0x76B832B66D6CBEbE390a3c2079207018d1045af7',
    ...
    const sportOptions: SuggestionOption[] = [
      {
        ...
        merchantAddress: '0x8892a065D397aB47833010E102f8319f39B54508',
      ...
      },
      {
        ...
        merchantAddress: '0x32a81F5b128eA9010C3478d1045af7698a32b66d',
...
Indica cosa desideri prenotare, per quante persone e l'orario desiderato.`,
  ...
  const proposal: ParsedIntent = {
    ...
    explanation: `Ho verificato la disponibilità per **${venueName}** (${venueLocation}) per **${dateText.toLowerCase()}** alle **${timeSlot}** (${count} persona/e).\n\nPer confermare e registrare il pass sul blocco Avalanche C-Chain, firma la transazione di deposito cauzionale (${DEPOSIT_AVAX} AVAX) con il tuo wallet Web3.`,
    isOutdoor,
    groupId,
  };
